...
public class Organisation extends TableImpl<OrganisationRecord> {
     ...
     */
    public final TableField<OrganisationRecord, Integer> ID = createField(DSL.name("id"), SQLDataType.INTEGER.nullable(false), this, "");
    ...
    /**
     * The column <code>public.Organisation.tax</code>.
     */
    public final TableField<OrganisationRecord, Integer> TAX = createField(DSL.name("tax"), SQLDataType.INTEGER, this, "");

    /**
     * The column <code>public.Organisation.checkingAcc</code>.
     */
    public final TableField<OrganisationRecord, Integer> CHECKINGACC = createField(DSL.name("checkingAcc"), SQLDataType.INTEGER, this, "");
