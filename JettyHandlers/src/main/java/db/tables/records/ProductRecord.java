...
public class ProductRecord extends UpdatableRecordImpl<ProductRecord> implements Record4<Integer, String, String, Integer> {
     ...
     */
    public ProductRecord setProducer(String value) {
        set(2, value);
        return this;
    }
    ...
    public Field<String> field3() {
        return Product.PRODUCT.PRODUCER;
    }
     ...
     */
    public ProductRecord(Integer id, String name, String producer, Integer quantity) {
        super(Product.PRODUCT);
